...
async def analyze_dispute(
    ...
    try:
        logger.info(f"Analyzing dispute for transaction: {request.transaction_id}")
        ...
        logger.info(f"Dispute analysis completed for transaction: {request.transaction_id}")
        ...
        logger.error(f"Failed to analyze dispute: {str(e)}", exc_info=True)
        raise HTTPException(
